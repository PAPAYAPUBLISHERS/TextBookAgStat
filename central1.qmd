...
![Measures of central tendency](images/Measures%20of%20Central%20Tendency.png){fig-alt="Measures of central tendency" fig-align="center" width="80%" style="text-align:center;"}
...
Total frequency = 3 + 4 + 7 + 6 + 3 = 23 (odd number). Since the number of scores is odd, the median is at $\left( \frac{23 + 1}{2} \right)^{\text{th}} =$ 12^th^ position. To find out the 12^th^ position, we use less than cumulative frequencies as shown:
