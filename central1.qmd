...
**Example 4.2** Table below shows the plant height of 50 plants. Find
...
**Example 4.3** Shows the distribution of the marks scored by 60
...
: Distribution of the marks scored by 60 students {#tbl-math}
...
Consider the Example 4.3 see Table:\@ref(tab:math)
...
**Example 4.4** Find the median of each of the following sets of
numbers.
...
**Example 4.5**: The following is a frequency table of the score
...
**Example 4.6**: The table is a frequency table of the marks obtained in
...
![median from a cumulative frequency curve](images/mediancf.png){fig-align="left" width="50%"}  

**Example 4.7** Table below gives the distribution of the heights of 60
...
: Distribution of heights of 60 students {#tbl-medianheight}
...
![Median from a cumulative frequency curve Example 4.7](images/cf.png){fig-align="left" width="50%"}   
...
**Example 4.9** 20 patients selected at random had their blood groups
...
: Blood group of 20 patients {#tbl-letters}
...
**Example 4.10** For the frequency distribution of weights of sorghum
...
: frequency distribution of weights of sorghum ear heads { (#tbl-earhead)}
...
!['Median from a cumulative frequency curve for Example 4.10](images/l2m1.jpeg){fig-align="left" width="50%"}  
