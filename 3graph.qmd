...
![Frequency Polygon](images/frpolygon.png){#fig-fp width="300"}

![Frequency Polygon and Histogram](images/histpoly.png){#fig-fph width="300" height="180"}
:::
...
::: {layout-ncol="2"}
![Sales data of agricultural produce](images/image14.jpeg){#fig-cbsales style="text-align:center;"}

![Component Barchart](images/image15.jpeg){#fig-cbar style="text-align:center;"}
:::
