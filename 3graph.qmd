...
**Grouped bar chart**
@fig-cbsales can also be represented using a grouped bar chart shown in @fig-groupedbar. For a grouped bar chart, the components are grouped together and drawn side by side.  
