...
![Statistical Account of Scotland by Sir John Sinclair (1791)](images/history1.png){fig-alt="Statistical Account of Scotland by Sir John Sinclair (1791)" fig-align="center" style="text-align:center;" width="30%"}
...
![Classification of variables](images/image2.png){out-width="100%" fig-alt="Classification of variables" fig-align="center"style="text-align:center;"}
...
![Raw data set of no. of fruits per branch in a mango tree](images/freq1.png){fig-alt="Raw data set of no. of fruits per branch in a mango tree" fig-align="center" out-width="100%"style="text-align:center;"}
...
![Plant height of 20 paddy varieties](images/fig1.5.png){fig-alt="Plant height of 20 paddy varieties" fig-align="center" out-width="100%"style="text-align:center;"}
