...
This chapter serves as the foundation of our exploration into the field of statistics. We begin by introducing the key concepts and definitions that shape the discipline of statistics. Understanding these concepts is essential for anyone engaging in data analysis and interpretation.

We will then move on to the methods of data collection and classification, which form the backbone of any statistical study. Proper collection and organization of data are crucial for ensuring the accuracy and relevance of the findings.

Finally, we will delve into the formation of frequency distributions, a vital tool for summarizing and analyzing large sets of data. Frequency distributions allow us to identify patterns, trends, and anomalies within data, making it easier to draw meaningful conclusions.

By the end of this chapter, you will have a solid understanding of these fundamental aspects of statistics, which will serve as a stepping stone to more advanced statistical techniques. [@goon] [@gupta]
...
![](images/history1.png){fig-alt="Statistical Account of Scotland by Sir John Sinclair (1791)" fig-align="center" fig-height="4"}
...
![](images/image2.jpeg){fig-alt="Classification of variables" fig-align="center" out-width="100%"}
...
![](images/freq1.png){fig-alt="Raw data set of no. of fruits per branch in a mango tree" fig-align="center" out-width="100%"}
...
![](images/fig1.4.png){fig-alt="Frequency distribution table" fig-align="center" out-width="100%"}
...
![](images/fig1.5.png){fig-alt="Plant height of 20 paddy varieties" fig-align="center" out-width="100%"}
...
![](images/fig1.6.png){fig-alt="Grouped Frequency distribution table" fig-align="center" out-width="100%"}
...
![](images/fig1.7.png){fig-alt="Class boundary and class limits" fig-align="center" out-width="100%"}
